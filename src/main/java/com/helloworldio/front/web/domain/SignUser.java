...
public abstract class SignUser implements Serializable {
	
	private static final long serialVersionUID = 3760194688493337630L;

	@NotNull(message="{common.form.field.empty.error}")
	@NotEmpty(message="{common.form.field.empty.error}")
	@Size(max=12, min=6, message="{common.form.field.length.error}")
